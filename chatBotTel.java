public class chatBotTel {
    public static void main(String args[]){
        ...
        if (answer2.equals("yes")){
            ...
            StdOut.print("That's double the amount of water! Not only is it better for our environment, ");
            StdOut.print("but it saves you time because you're spending less time on refilling your bottles.");
            StdOut.println("Humans use 1.2 million plastic bottles per minute, according to EarthDay.com.");
            StdOut.print("Americans buy 50 billion water bottles per year.");
            StdOut.print("That's about 13 bottles per month per person in the US.");
        } else {
        ...
        if (answer3.equals("yes")){
            ...
            StdOut.print("Each of these bags takes 1,000 years to disintegrate completely.");
